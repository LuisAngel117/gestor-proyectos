...
class SprintPlanningUnassignTest extends TestCase
{
    use RefreshDatabase;

    public function test_owner_can_unassign_items_from_sprint(): void
    {
        ...
        $response = $this->actingAs($owner)->post(route('sprints.plan.unassign', [$project, $sprint]), [
            'items' => [$item->id],
        ]);
